...
![Advanced Mode with Tree](vscode-extension/images/advanced-mode-with-tree.png)

**Normal Mode with Tree** for a cleaner look:

![Normal Mode with Tree](vscode-extension/images/normal-mode-with-tree.png)

### Settings

![Settings](vscode-extension/images/settings.png)
